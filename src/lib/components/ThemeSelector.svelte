  ...
  const themes: { value: Theme; label: string; description: string }[] = [
    {
      value: 'minimal',
      label: 'Minimal',
      description: 'Sauber und einfach mit viel Weißraum'
    },
    {
      value: 'elegant',
      label: 'Elegant',
      description: 'Serif-Überschriften mit raffinierter Typografie'
    }
  ];
...
<fieldset class="space-y-3">
  <legend class="text-sm font-medium theme-heading mb-3">Dokument-Theme</legend>
